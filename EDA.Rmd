...
geom_line() +
geom_point() +
labs(title = "OD trends, Colored by Mine", x = "Time", y = "OD")
...
geom_line() +
geom_point() +
labs(title = "OD trends, Colored by Storage Method", x = "Time", y = "OD")
...
geom_line() +
geom_point() +
labs(title = "OD trends, Colored by Media", x = "Time", y = "OD")
...
hist(dataset_mod$Maximum_Concentration^0.1, main = "Histogram of power-transformed Maximum Concentration",xlab = "Maximum_Concentration^0.1",ylab = "Frequency")
